;DoN --- The DoN OS Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE DoNOS_VER '1.0.0'	 ;OS version number
	%DEFINE DoNOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db '@@@@*************////\\\\Welcome to DoN OS////\\\\****************@@@@', 0
	os_version_msg		db 'Version ', DoNOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', DoNOS_VER, 0

	dialog_string_1		db 'Welcome to DoN Operating System', 0
