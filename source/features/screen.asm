; ==================================================================
; DoN OS -- The DoNOS Operating System kernel
;
...
.redbox:				; Loop to draw all lines of box
	...
	mov bh, 0
	mov cx, 42
	mov bl, 10100000b		; black on green
	mov al, ' '
	int 10h
	popa
...
.one_button:
	mov bl, 00011111b		; blue on white
	mov dh, 14
	mov dl, 35
	mov si, 8
	mov di, 15
...
.two_button_wait:
	...
	mov bl, 01101111b		; White on brown for cancel button
	mov dh, 14
	mov dl, 42
	mov si, 9
	mov di, 15
...
.noleft:
	...
	mov bl, 01101111b		; Black on white
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15
